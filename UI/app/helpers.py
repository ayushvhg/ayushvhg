...
def send_otp_signin(to_email, otp):
    sender_email = "ayushvhg@gmail.com"
    sender_password = "jgflzubltfdknvyp"
    ...
    body = f"Your OTP is {otp}. This OTP is valid for 10 minutes. Thankyou for choosing AYUSH VIRTUAL HERBAL GARDEN ."
